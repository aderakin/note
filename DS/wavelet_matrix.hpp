...
// - `WaveletMatrix(n)`: Generate a WaveletMatrix with n elements.
//  - `set(i, x)`: Assign x to the i-th element.
//  - `build()`: Build a data structure.  (Do not call `set(i, x)` from now on.)
//  - `access(k)`: Get the value of the kth element.
//  - `kth_smallest(l, r, k)`: Returns the k(0-indexed) smallest value in the range `[l, r)`.
//  - `kth_largest(l, r, k)`: Returns the k(0-indexed) largest value in the range `[l, r)`.
//  - `range_freq(l, r, upper)`: Returns the number of elements less than upper in the range `[l, r)`.
//  - `prev_value(l, r, lower)`: Returns the last value less than upper in the range `[l, r)`.
//  - `next_value(l, r, lower)`: Returns the first value greater than or equal to lower in the range `[l, r)`.
